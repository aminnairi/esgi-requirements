...
type Message
  = ValidateBranchPromotionRequirement Branch Promotion Requirement Bool
...
update action model = 
  case action of
    ValidateBranchPromotionRequirement branch promotion requirement validated ->
...
viewPromotion branch promotion =
  Html.div
    ...
    [ Html.h3
      ...
      , viewButton [ Html.Events.onClick ( ResetBranchPromotionRequirements branch promotion ) ] [ Html.text "Réinitialiser" ]
      ]
